...
public class FoodBoardController {
 ...
 // 1. 게시글 좋아요 API
    ...
    public Map<String, Object> likeBoardApi(@RequestParam Long boardId, HttpSession session) {
        ...
        postService.toggleLike(boardId, "BOARD", loginUser.getUsername());
        int likeCount = postService.getLikeCount(boardId, "BOARD");
        boolean liked = postService.isLiked(boardId, "BOARD", loginUser.getUsername());
    ...
    public Map<String, Object> addCommentApi(@RequestParam Long boardId,
        ...
        response.put("success", true);
        response.put("commentId", saved.getId());
        response.put("content", saved.getContent());
        response.put("author", loginUser.getName());
        response.put("profileImageUrl", loginUser.getProfileImageUrl());
    ...
    public Map<String, Object> likeCommentApi(@RequestParam Long commentId, HttpSession session) {
        ...
        postService.toggleLike(commentId, "COMMENT", loginUser.getUsername());
        int likeCount = postService.getLikeCount(commentId, "COMMENT");
        boolean liked = postService.isLiked(commentId, "COMMENT", loginUser.getUsername());
    ...
    public Map<String, Object> likeReplyApi(@RequestParam Long parentId,
        ...
        postService.toggleLike(replyId, "COMMENT", loginUser.getUsername());
        int likeCount = postService.getLikeCount(replyId, "COMMENT");
        boolean liked = postService.isLiked(replyId, "COMMENT", loginUser.getUsername());
